...
public class ProductController {
    ...
    public ResponseEntity<?>createProduct(@RequestPart("productDTO") ProductDTO productDTO, @RequestPart(value = "images", required = false) List<MultipartFile> images){
        try {
    ...
    public ResponseEntity<Product>patchProduct(@RequestPart("productDTO") ProductPatchDTO patch, @RequestPart(value = "images", required = false) List<MultipartFile> patchImages){
        try {
